...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='_facebook', unique=True, to=orm['auth.User'])),
            ('facebook_id', self.gf('django.db.models.fields.CharField')(max_length=130)),
    ...
    models = {
        'accounts.userprofile': {
            ...
            'facebook_id': ('django.db.models.fields.CharField', [], {'max_length': '130'}),
